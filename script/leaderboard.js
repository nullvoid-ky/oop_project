    ...
    fetch(url + "/api/controller/get-leaderboard", requestOptions)
        ...
        .then((data) => {
            data.data.forEach((item) => {
                ...
                createRankingBox(accountId, username, displayName, picUrl, star, amount, gender, rank);
            })
        })
...
function createRankingBox(accountId, username, displayName, picUrl, star, amountBooked, gender, rank){
